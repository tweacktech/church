                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ route('updateEvent', ['id' => $update->id]) }}"
                               ...
                               name="Title" value="{{$update->Title}}" required>
                               @error('Title')
                                     <div class="mb-5">
                             ...
                             <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="origin" 
                               name="time" value="{{$update->time}}" >
                               @error('time')
                                     <div class="mb-5">
                                     <label class="fs-6 form-label fw-bolder " style="color:red" >{{ $message }}</label>
                                      </div>
