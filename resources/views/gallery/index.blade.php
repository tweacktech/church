                  ...
                  <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Gallerys</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gallery Schedules</h4>
                        ...
                        @foreach ($data as $data)
                            <tr>
                               ...
                               <td style="width: 100px;">
                                   <img width="100%"src="{{asset('/gallery/'.$data->Image)}}" alt="images/demo/348x261.png"> 
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="loginModalLabel">Gallery Sermon</h5>
                    ...
                    <div class="modal-body">
                        <!-- Login Form -->
                        <form id="loginForm" action="{{route('addGallery')}}" method="POST"enctype="multipart/form-data" >
                        @csrf
                        @method('post')
